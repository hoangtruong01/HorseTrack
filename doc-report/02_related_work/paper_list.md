...
| 01 | Horse Racing Prediction Using Artificial Neural Networks | Elnaz Davoodi, Ali Reza Khanteymoori | 2010 | RECENT ADVANCES in NEURAL NETWORKS | Conference Proceeding | Cơ sở lý thuyết AI cốt lõi: Cung cấp kiến trúc mạng nơ-ron đa lớp ANN 8-5-7-1 để triển khai tính năng dự đoán thời gian hoàn thành chặng và xếp hạng ngựa. |
| 02 | Smart Tournament Scheduling Using a POX-Heuristic Genetic Algorithm | Mu-Chun Su, Jieh-Haur Chen, Jieh-Haur Chen, Che-Hsuan Chang, Hsi-Hsien Wei | 2025 | WorldScientific | Journal Article | Tính năng Lập lịch (Admin): Ứng dụng toán tử lai POX kết hợp thuật toán di truyền (GA) để tự động hóa luồng xếp lịch thi đấu chặng trực quan, tránh trùng lịch. |
| 03 | A Step Towards Cognitive Automation: Integrating LLM Agents with Process Rules | Sascha Kaltenpoth, Alexander Skolik, Oliver Müller, Daniel Beverungen | 2025 | ResearchGate | Preprint | Quy trình Phê duyệt (Admin): Cơ sở để thiết lập hệ thống kiểm tra điều lệ giải đấu tự động (Rule Engine), tăng tốc luồng duyệt hồ sơ đăng ký thi đấu trực tuyến. |
