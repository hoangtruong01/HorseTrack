                ...
                {results.map((res, index) => (
                  ...
                  >
                    ...
                    <td className="p-4 font-bold text-white uppercase">
                      {res.horseId?.name || "Chiến mã ẩn"}
                    </td>
                    <td className="p-4 text-white/60">
                      {res.horseId?.breed || "Chưa xác định"}
                    </td>
                    <td className="p-4 text-white">
                      {res.jockeyUserId?.fullName || "Nài ngựa ẩn"}
                    </td>
                    ...
                    <td
                      className={`p-4 ${res.incident !== "none" && res.incident !== "NONE" ? "text-primary font-bold" : "text-white/40"}`}
                    >
                      {res.note ||
                        (res.incident !== "none" && res.incident !== "NONE"
                          ? res.incident
                          : "Không")}
                    </td>
