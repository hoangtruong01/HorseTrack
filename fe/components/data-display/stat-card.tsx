...
export function StatCard({
  ...
  return (
    <article
      className={cn(
        "group relative overflow-hidden rounded-xl border border-border bg-card/85 p-4 shadow-[0_16px_40px_rgba(0,0,0,0.2)] transition duration-200 hover:-translate-y-0.5 hover:border-border sm:p-5",
        className,
      )}
    >
      <div
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-3 text-4xl font-black uppercase leading-none tracking-tight text-foreground sm:text-5xl">
            {value}
          </p>
        </div>
        <div
      ...
      {trend ? (
        <p className="mt-3 inline-flex rounded-full border border-border bg-muted px-2.5 py-1 text-xs font-bold uppercase tracking-[0.14em] text-foreground">
          {trend}
        </p>
      ) : null}
    </article>
