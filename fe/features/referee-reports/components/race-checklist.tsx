...
export function RaceChecklist({ items }: RaceChecklistProps) {
  ...
  return (
    <section className="rounded-2xl border dark:border-white/10 border-border dark:bg-[#15151E]/90 bg-card p-4 shadow-[0_18px_56px_rgba(0,0,0,0.3)] sm:p-6">
            ...
            <article
              ...
              className={cn(
                ...
                item.status === "attention"
                  ...
                  : "dark:border-white/10 border-border dark:bg-black/20 bg-muted/20",
              )}
            >
              ...
              <h3 className="mt-4 font-black uppercase dark:text-white text-foreground">
                {item.label}
              </h3>
