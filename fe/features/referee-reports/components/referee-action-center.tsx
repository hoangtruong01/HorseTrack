...
export function RefereeActionCenter({
  ...
  return (
    <div className="space-y-6">
      <section className="relative overflow-hidden rounded-3xl border dark:border-white/10 border-border dark:bg-[#15151E] bg-card p-5 shadow-[0_24px_80px_rgba(0,0,0,0.36)] sm:p-7 lg:p-8">
        <div className="absolute inset-0 dark:bg-[linear-gradient(125deg,rgba(225,6,0,0.28),transparent_34%),radial-gradient(circle_at_88%_20%,rgba(6,126,106,0.22),transparent_28rem)] bg-card" />
        <div className="relative grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <div>
            ...
            <h1 className="mt-5 text-4xl font-black uppercase leading-tight dark:text-white text-foreground sm:text-5xl">
          ...
          <div className="rounded-2xl border dark:border-white/10 border-border dark:bg-black/25 bg-muted/20 p-4">
            ...
            <p className="mt-2 text-2xl font-black uppercase dark:text-white text-foreground">
              {profile.name}
            </p>
      ...
      <section className="grid gap-4 lg:grid-cols-[1fr_0.8fr]">
        <article className="rounded-2xl border border-primary/25 dark:bg-[linear-gradient(135deg,rgba(225,6,0,0.16),rgba(21,21,30,0.94))] bg-card p-5">
        ...
        <article className="rounded-2xl border dark:border-white/10 border-border dark:bg-[#15151E]/90 bg-card p-5">
          <p className="text-xs font-bold uppercase tracking-[0.24em] text-primary">
            Report queue
          </p>
          <h2 className="mt-2 text-2xl font-black uppercase dark:text-white text-foreground">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {assignments.map((assignment) => (
          <article
            ...
            className="rounded-2xl border dark:border-white/10 border-border dark:bg-[#15151E]/85 bg-card p-5"
          >
            <StatusBadge
            ...
            />
            <h3 className="mt-4 text-xl font-black uppercase dark:text-white text-foreground">
