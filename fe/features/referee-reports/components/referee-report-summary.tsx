...
export function RefereeReportSummary({ report }: RefereeReportSummaryProps) {
  ...
  return (
    <article className="rounded-2xl border border-border/10 bg-[#15151E]/90 p-5 shadow-[0_18px_56px_rgba(0,0,0,0.28)]">
      ...
      <dl className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border border-border/10 bg-black/20 p-4">
          <dt className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
            Referee
          </dt>
          <dd className="mt-2 font-black text-foreground">{report.referee}</dd>
        </div>
        <div className="rounded-xl border border-border/10 bg-black/20 p-4">
          <dt className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
            Checks
          </dt>
          <dd className="mt-2 font-mono text-2xl font-black text-foreground">
        ...
        <div className="rounded-xl border border-border/10 bg-black/20 p-4">
          ...
          <dd className="mt-2 font-bold text-foreground">{report.submittedAt}</dd>
        </div>
      </dl>
      <p className="mt-5 rounded-xl border border-border/10 bg-black/20 p-4 text-sm leading-6 text-muted-foreground">
