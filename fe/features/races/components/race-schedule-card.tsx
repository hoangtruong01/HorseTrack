...
export function RaceScheduleCard({ race }: RaceScheduleCardProps) {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-border/10 bg-[#1C1C25] p-5 shadow-[0_20px_64px_rgba(0,0,0,0.3)] sm:p-6">
      ...
      <div className="relative">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border/10 bg-black/20 p-4">
            ...
            <p className="mt-1 text-lg font-black text-foreground">{race.date}</p>
