...
export function AuthCard({
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] border border-border/10 bg-[#111118]/92 p-5 shadow-[0_28px_100px_rgba(0,0,0,0.52)] sm:p-6 lg:p-8">
      ...
      <div className="relative">
        ...
        <h1 className="mt-3 text-3xl font-black uppercase leading-tight text-foreground sm:text-4xl">
          {title}
        </h1>
        ...
        <div className="mt-7 rounded-2xl border border-border/10 bg-muted/[0.035] p-4">
