...
Behavioral guidelines for Claude Code and Claude-compatible agents using this `ai-workflows/` repo.
...
- Read `PORTABILITY.md` for copy strategy across Roo, Claude Code, Codex, and future projects.
